...
`--bot`::
	...
	and disable terminal prompts for credentials by setting
	`GIT_TERMINAL_PROMPT=0`. This is useful for CI/CD pipelines and
	scripts where no user interaction is possible.
